...
class bn_inception(nn.Module):
    def __init__(self, embedding_size, bg_embedding_size = 1024, pretrained = True, is_norm=True, is_student = True, bn_freeze = True):
        ...
        self.model = BNInception(1024)
        if pretrained:
            model_path = './proxy_net/bn_inception-52deb4733.pth'
            weight = torch.load(model_path)
            #weight = bn_inception-52deb4733.pth#model_zoo.load_url('http://data.lip6.fr/cadene/pretrainedmodels/bn_inception-52deb4733.pth')
...
class BNInception(nn.Module):
    ...
    def features(self, input):
        ...
        return inception_3c_output_out, inception_4e_output_out, inception_5b_output_out